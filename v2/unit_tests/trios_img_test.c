...
UTEST(read_image) 
    img_t *img  = img_readPGM("test_images/test_read.pgm");
...
UTEST(read_real_image) {
    img_t *img  = img_readPGM("test_images/input1.pgm");
    img_free(img);
    img  = img_readPGM("test_images/input2.pgm");
    img_free(img);
    img  = img_readPGM("test_images/input3.pgm");
    img_free(img);
    img  = img_readPGM("test_images/ideal1.pgm");
    img_free(img);
    img  = img_readPGM("test_images/ideal2.pgm");
    img_free(img);
    img  = img_readPGM("test_images/ideal3.pgm");
    img_free(img);
} TEST_END
